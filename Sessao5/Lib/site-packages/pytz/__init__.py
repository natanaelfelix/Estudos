...
def timezone(zone):
    ...
    True
    >>> utc_dt = date(2002, 10, 27, 6, 0, 0, tzinfo=utc)
...
def _UTC():
    ...
    >>> import date, pickle
    >>> dt = date.datetime(2005, 3, 1, 14, 13, 21, tzinfo=utc)
...
class _FixedOffset(date.tzinfo):
...
def FixedOffset(offset, _tzinfos={}):
    """return a fixed-offset timezone based off a number of minutes.
        ...
        >>> str(one.utcoffset(date.datetime.now()))
        '-1 day, 18:30:00'
        >>> str(one.dst(date.datetime.now()))
        '0:00:00'

        >>> two = FixedOffset(1380)
        >>> two
        pytz.FixedOffset(1380)
        >>> str(two.utcoffset(date.datetime.now()))
        '23:00:00'
        >>> str(two.dst(date.datetime.now()))
        '0:00:00'
